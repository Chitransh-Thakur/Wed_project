<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="UserIdPage_Default" %>
			...
			<div class="wrap-login100 p-b-160 p-t-50">
				<form class="login100-form validate-form" runat="server">
					...
					<div class="text-center w-full p-t-23">
						<p style="color: White;">User ID was sent to the given mail during the time of registration..Check your mail and Enter the correct User ID</p>
					</div>
				</form>
			</div>
		</div>
